...
var useState = useState$6, useEffect = useEffect$3, useReducer = useReducer$1, useRef = useRef$1, useCallback = useCallback$1;
...
var SliderContextProvider = function (props) {
    ...
    return (createElement(SliderContext.Provider, { value: {
...
var useContext = useContext$8, memo = memo$b;
var ButtonSVG = function () { return (createElement("svg", { width: "60px", height: "60px", strokeWidth: "5", version: "1.1", viewBox: "0 0 129 129" },
    createElement("g", { fill: "currentColor" },
        createElement("path", { d: "m40.4,121.3c-0.8,0.8-1.8,1.2-2.9,1.2s-2.1-0.4-2.9-1.2c-1.6-1.6-1.6-4.2 0-5.8l51-51-51-51c-1.6-1.6-1.6-4.2 0-5.8 1.6-1.6 4.2-1.6 5.8,0l53.9,53.9c1.6,1.6 1.6,4.2 0,5.8l-53.9,53.9z" })))); };
var Buttons = function (props) {
    var isMobile = useContext(SliderContext).isMobile;
    if (isMobile)
        return null;
    return (createElement(Fragment, null,
        createElement(Wrapper$1, { className: [
                'slide-button-previous',
                props.isHorizontal ? 'slide-button-horizontal' : 'slide-button-vertical',
            ].join(' ') },
            createElement("div", { className: "slide-button-container" },
                createElement("button", { onClick: props.previousSlide, className: "slide-button-button-svg" },
        ...
        createElement(Wrapper$1, { className: [
            ...
            createElement("div", { className: "slide-button-container" },
                createElement("button", { onClick: props.nextSlide, className: "slide-button-button-svg" },
                    createElement(ButtonSVG, null))))));
};
var Buttons$1 = memo(Buttons);

var useContext$1 = useContext$8, useEffect$1 = useEffect$3, useState$1 = useState$6, useLayoutEffect = useLayoutEffect$1, memo$1 = memo$b;
var HeroSlider = memo$1(function (props) {
     ...
     */
    var initialSettings = useMemo$4(function () { return (__assign({ 
        // Dependants
    ...
    var settings = useMemo$4(function () { return (__assign({}, sliderSettings, props.settings)); }, [sliderSettings, props.settings]);
    ...
    return (createElement(ThemeProvider, { theme: styledComponentsTheme },
        createElement(Wrapper, { ref: sliderRef, onTouchStart: onTouchStartHandler, onTouchMove: onTouchMoveHandler, onTouchEnd: onTouchEndHandler, style: __assign({}, props.style, { width: settings.width, height: settings.height }), onMouseMoveCapture: onMouseMoveCaptureHandler },
            props.children,
            settings.shouldDisplayButtons && (createElement(Buttons$1, { isHorizontal: settings.sliderOrientation === EOrientation.HORIZONTAL, previousSlide: setPreviousSlide, nextSlide: setNextSlide })))));
});
var WithProvider = memo$1(function (props) {
    ...
    return (createElement(SliderContextProvider, { isMobile: isMobile },
        createElement("div", { className: "rm-hero-slider", ref: ref },
            createElement(HeroSlider, __assign({ inView: inView }, rest)))));
});
...
var ExtendedThemeProvider = function (props) {
    ...
    return (createElement(ThemeProvider, { theme: __assign({}, theme, extendedTheme) }, children));
};
...
var setAnimation = css(templateObject_6$1 || (templateObject_6$1 = __makeTemplateObject(["", ""], ["",
    ""])), function (_a) {
    var theme = _a.theme;
...
var useState$2 = useState$6, memo$3 = memo$b;
var SlideBackground = function (props) {
    ...
    var content = (createElement(Fragment, null,
        backgroundImage && (createElement(Img, { className: "slide-background-loader", onLoad: onLoadHandler, alt: alt, src: backgroundImage })),
        createElement(Background, { style: style, className: className })));
    return (shouldLazyLoad ? (createElement(LazyLoad, { offset: lazyLoadingOffset || window.innerHeight, debounce: false, height: height || '100%' }, content)) : content);
};
...
// Libraries
var useState$3 = useState$6, memo$4 = memo$b;
var BackgroundMask = function (props) {
    ...
    return (createElement(Mask, { className: [
            'slide-background-mask',
            (props.isActive && props.isDoneSliding) ? 'slide-background-mask-active' : 'slide-background-mask-inactive',
        ].join(' ') },
        createElement(LazyLoad, { offset: window.innerHeight, debounce: false, height: "100%" },
            createElement(Img$1, { className: "slide-background-mask-loader", onLoad: onLoadHandler, src: background.backgroundImage }),
            isLoaded && (createElement("div", { style: style, className: [
                    className,
...
var useContext$2 = useContext$8, useEffect$2 = useEffect$3, useState$4 = useState$6, memo$5 = memo$b;
var HeroSlide = memo$5(function (props) {
    ...
    return (createElement(ExtendedThemeProvider$1, { extendedTheme: extendedTheme },
        createElement(StyledSlide, __assign({ style: __assign({}, style), isActive: isActive, isDoneSliding: isDoneSliding, slidingAnimation: slidingAnimation }, rest),
            createElement(Background$1, __assign({ onLoad: onBackgroundLoad }, background)),
            createElement("div", { className: "slide-wrapper" },
                shouldRenderMask ? (createElement(Mask$1, { background: background, isActive: isActive, isDoneSliding: isDoneSliding })) : null,
                children && (createElement("div", { className: [
                        'slide-container',
                        (isActive && isDoneSliding) ? 'slide-active' : null,
                    ].join(' ') }, children))))));
});
var Slide = function (props) { return createElement(HeroSlide, __assign({}, props)); };
...
var useContext$3 = useContext$8, useMemo = useMemo$4, memo$6 = memo$b;
var SliderNav = memo$6(function (props) {
    ...
    var navButtons = useMemo(function () {
        ...
        return slidesArray.map(function (_, index) {
            return (createElement("li", { onClick: function () { return changeSlideHandler(index); }, key: index, className: [
                    'slide-nav-button',
    ...
    return (createElement(ExtendedThemeProvider$1, { extendedTheme: extendedTheme },
        createElement(Wrapper$2, { style: __assign({ bottom: !position ? '1.5rem' : undefined, left: !position ? '50%' : undefined, transform: !position ? 'translateX(-50%)' : undefined }, position) }, navButtons)));
});
var Nav = function (props) { return createElement(SliderNav, __assign({}, props)); };
...
var useContext$4 = useContext$8, useMemo$1 = useMemo$4, memo$7 = memo$b;
    ...
    var navButtons = useMemo$1(function () {
        ...
        return slidesArray.map(function (_, index) {
            ...
            return (createElement("li", { onClick: function () { return changeSlideHandler(index); }, key: index, className: [
                ...
                createElement("span", { className: "slide-side-nav-button-line" }),
                createElement("span", { className: "slide-side-nav-button-number" }, respectiveSlide)));
        });
    }, [navProps, slidesArray, isPositionedRight]);
    return (createElement(ExtendedThemeProvider$1, { extendedTheme: extendedTheme },
        createElement(Wrapper$3, { style: __assign({ top: !position ? '50%' : undefined, left: !position && !isPositionedRight ? left || '1rem' : undefined, right: !position && isPositionedRight ? right || '1rem' : undefined, transform: !position ? 'translateY(-50%)' : undefined }, position) }, navButtons)));
});
var SideNav = function (props) { return createElement(SliderNav$1, __assign({}, props)); };
...
var useContext$5 = useContext$8, useMemo$2 = useMemo$4, memo$8 = memo$b;
var SliderNav$2 = memo$8(function (props) {
    ...
    var MenuNavButtons = useMemo$2(function () {
        ...
        return slidesArray.map(function (_a, index) {
            ...
            return (createElement("li", { onClick: function () { return changeSlideHandler(index); }, key: index, className: [
                ...
                createElement("div", { className: "slide-menu-nav-button-description" },
                    createElement("div", { className: "slide-menu-nav-button-number" },
                        respectiveSlide,
                        createElement("span", { className: "slide-menu-nav-button-square" })),
                    createElement("div", { className: "slide-menu-nav-button-text" }, description))));
        });
    }, [navProps, slidesArray]);
    if (sliderWidth <= mobileThreshold) {
        if (isNullAfterThreshold)
            return null;
        return (createElement(Nav, __assign({}, props)));
    }
    if (!navProps)
        return null;
    ...
    return (createElement(ExtendedThemeProvider$1, { extendedTheme: extendedTheme },
        createElement(Wrapper$4, { style: __assign({ bottom: !position ? '0' : undefined, left: !position ? '50%' : undefined, transform: !position ? 'translateX(-50%)' : undefined, justifyContent: justifyContent || 'center' }, position) },
            extraButton && (createElement(ExtraButtonWrapper, { isExtraButtonRight: isExtraButtonRight },
                createElement(ExtraButton, { isExtraButtonRight: isExtraButtonRight }, extraButton))),
            createElement(Container$1, null,
                MenuNavButtons,
                createElement(Bar, { style: {
                        width: 100 / totalSlides + "%",
                        transform: "translate3d(" + (activeSlide - 1) + "00%, 0, 0)",
                    } })))));
});
var MenuNav = function (props) { return createElement(SliderNav$2, __assign({}, props)); };
...
var navBackgroundColor = function (defaultBackgroundColor) { return css(templateObject_6$7 || (templateObject_6$7 = __makeTemplateObject(["", ""], ["", ""])), function (_a) {
    var theme = _a.theme;
...
var useContext$6 = useContext$8, useMemo$3 = useMemo$4, memo$9 = memo$b;
var SliderNav$3 = memo$9(function (props) {
    ...
    var ButtonNavButtons = useMemo$3(function () {
        ...
        return slidesArray.map(function (_a, index) {
            ...
            var description = navDescription;
            var respectiveSlide = index + 1;
            return (createElement(Button, { key: index, onClick: function () { return changeSlideHandler(index); }, className: activeSlide === respectiveSlide ? 'slide-button-nav-active-button' : undefined },
    ...
    return (createElement(ExtendedThemeProvider$1, { extendedTheme: extendedTheme },
        createElement(Wrapper$5, { style: __assign({ bottom: !position ? '0' : undefined, left: !position ? '50%' : undefined, transform: !position ? 'translateX(-50%)' : undefined }, position) },
            createElement(Container$2, { style: {
                ...
                ButtonNavButtons,
                extraButton && (createElement(ExtraButton$1, { style: {
                        order: isExtraButtonRight ? 1 : 0,
                    } }, extraButton))))));
});
var ButtonsNav = function (props) { return createElement(SliderNav$3, __assign({}, props)); };
...
var useContext$7 = useContext$8, useState$5 = useState$6, memo$a = memo$b;
var AutoplayButtons = memo$a(function (props) {
    ...
    return (createElement(Button$1, { className: className, onClick: onClickHandler, style: __assign({ bottom: !position ? '0' : undefined, left: !position ? '0' : undefined }, position, style) },
        createElement("svg", { fill: "currentColor", height: "100%", width: "100%", viewBox: "0 0 36 36" },
            createElement("path", { d: setPath() }))));
});
var AutoplayButton = function (props) { return (createElement(AutoplayButtons, __assign({}, props))); };
...
export { AutoplayButton, ButtonsNav, MenuNav, Nav, OverlayContainer, SideNav, Slide };
